...
`r badger::badge_github_release()`
`r badger::badge_last_commit(branch = "dev")`
<!-- badges: end -->
...
Since release v0.6.13 we provide a [docker image for splice2neo](https://github.com/TRON-Bioinformatics/splice2neo/pkgs/container/splice2neo). Install it with:
