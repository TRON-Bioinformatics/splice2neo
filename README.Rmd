...
Splice2neo enables the user to transform junctions into a format so that they can be quantified in RNA-seq data (`transform_for_requant`) and to import results from this requantification (`map_requant` or `read_requant`). 
